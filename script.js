...
document.querySelector("#app").innerHTML = `
    ...
    <main id="cards">
        ...
        ${createCard("24/11", "quinta", createGame('switzerland', 'SUI', '07:00', 'cameroon', 'CMR', '1', '0') + createGame('uruguay', 'URU', '10:00', 'south-korea', 'KOR', '0', '0') + createGame('portugal', 'POR', '13:00', 'ghana', 'GHA', '3', '2') + createGame('brazil', 'BRA', '16:00', 'serbia', 'SRB', '', ''))}
...
<main id="cards">
    <h1>Classificação</h1>
    <span>Atualizado por último em: 24/11/2022 - 15h</span>
