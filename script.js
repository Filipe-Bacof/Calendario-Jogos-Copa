...
document.querySelector("#app").innerHTML = `
    ...
    <main id="cards">
        ...
        ${createCard("01/12", "quinta",
            ...
            createGame('canada', 'CAN', '12:00', 'morocco', 'MAR', '1', '2', corPlacar('2'), corPlacar('1')) +
            createGame('japan', 'JPN', '16:00', 'spain', 'ESP', '2', '1', corPlacar('1'), corPlacar('2')) +
            createGame('costa-rica', 'CRC', '16:00', 'germany', 'GER', '2', '4', corPlacar('2'), corPlacar('1')))}
        ...
        // os dois jogos que precisa atualizar hoje
            ...
            createGame('portugal', 'POR', '16:00', 'switzerland', 'SUI', '', '', corPlacar(''), corPlacar('')))}
        ...
        //inserir os jogos de terça aqui 12h X 16h     corPlacar('1') ganhador ('2') perdedor ('3') empate
            createGame('morocco', 'MAR', '12:00', 'empty', '', '', '', corPlacar(''), corPlacar('')) +
...
<main id="cards">
    ...
    ${gerarGrupoCard('E',
        gerarEquipeNaTabela('japan', 'JAP', 'Japão', 6, 3, 2, 0, 1, 4, 3, 1, true) +
        gerarEquipeNaTabela('spain', 'ESP', 'Espanha', 4, 3, 1, 1, 1, 9, 3, 6, true) +
        gerarEquipeNaTabela('germany', 'GER', 'Alemanha', 4, 3, 1, 1, 1, 6, 5, 1, false) +
        gerarEquipeNaTabela('costa-rica', 'CRC', 'Costa Rica', 3, 3, 1, 0, 2, 3, 11, -8, false) )}
    ${gerarGrupoCard('F',
    ...
    ${gerarGrupoCard('G',
        gerarEquipeNaTabela('brazil', 'BRA', 'Brasil', 6, 3, 2, 0, 1, 3, 1, 2, true) +
        gerarEquipeNaTabela('switzerland', 'SUI', 'Suíça', 6, 3, 2, 0, 1, 4, 3, 1, true) +
        gerarEquipeNaTabela('cameroon', 'CMR', 'Camarões', 4, 3, 1, 1, 1, 4, 4, 0, false) +
        gerarEquipeNaTabela('serbia', 'SRB', 'Sérvia', 1, 3, 0, 1, 2, 5, 8, 3, false) )}
    ${gerarGrupoCard('H',
        gerarEquipeNaTabela('portugal', 'POR', 'Portugal', 6, 3, 2, 0, 1, 6, 4, 2, true) +
        gerarEquipeNaTabela('south-korea', 'KOR', 'Coréia do Sul', 4, 3, 1, 1, 1, 4, 4, 0, true) +
        gerarEquipeNaTabela('uruguay', 'URU', 'Uruguai', 4, 3, 1, 1, 1, 2, 2, 0, false) +
        gerarEquipeNaTabela('ghana', 'GHA', 'Gana', 3, 3, 1, 0, 2, 5, 7, -2, false) )}
    ${gerarLegendas()}
    </main>`
    ...
    <main id="cards">
        <div class="card">
            ...
            ${gerarLinhaMataMata('', 'quartas',
                ...
                gerarGameMataMata('morocco', 'Marrocos', '', 'MAR', 'empty', 'empty', '', '', '', '', true, '10/12', '12h', corPlacar(''), corPlacar('')) )}
