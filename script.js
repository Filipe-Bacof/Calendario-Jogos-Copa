...
document.querySelector("#app").innerHTML = `
    ...
    <main id="cards">
        ...
        ${createCard("23/11", "quarta", createGame('morocco', 'MAR', '07:00', 'croatia', 'CRO', '0', '0') + createGame('germany', 'GER', '10:00', 'japan', 'JPN', '-', '-') + createGame('spain', 'ESP', '13:00', 'costa-rica', 'CRC', '', '') + createGame('belgium', 'BEL', '16:00', 'canada', 'CAN', '', ''))}
