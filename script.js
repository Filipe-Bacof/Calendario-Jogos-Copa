...
document.querySelector("#app").innerHTML = `
    ...
    <main id="cards">
        ...
        ${createCard("25/11", "sexta", createGame('wales', 'WAL', '07:00', 'iran', 'IRN', '0', '2') + createGame('qatar', 'QAT', '10:00', 'senegal', 'SEN', '1', '3') + createGame('netherlands', 'HOL', '13:00', 'ecuador', 'ECU', '', '') + createGame('england', 'ENG', '16:00', 'united-states', 'USA', '', ''))}
...
<main id="cards">
    <h1>Classificação</h1>
    <span>Atualizado por último em: 25/11/2022 - 12h</span>
    <div class="card">
        <h3>Grupo A</h3>
        <table>
            ${gerarCabecalhoTable()}
